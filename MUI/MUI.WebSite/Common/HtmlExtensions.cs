...
namespace MUI.WebSite
{
    ...
    public static class HtmlExtensions
    {
        ...
        public static MvcHtmlString ForEditorX(this HtmlHelper Html, String name, Object value, Type type = null, String format = null, Object htmlAttributes = null)
        {
            ...
            switch (Type.GetTypeCode(type))
            {
                ...
                case TypeCode.UInt64:
                    if (type.IsEnum)
                        return Html.ForEnumX(name, value ?? 0.ChangeType(type), format, htmlAttributes);
                    else
        ...
        public static MvcHtmlString ForEditor<TModel, TProperty>(this HtmlHelper<TModel> Html, Expression<Func<TModel, TProperty>> expression, Object htmlAttributes = null)
        {
            ...
            return Html.ForEditorX(name, Html.ViewData.Model.GetValue(pi), pi.PropertyType, null, htmlAttributes);
        }
        ...
        /// <param name="htmlAttributes"></param>
        /// <returns></returns>
        public static MvcHtmlString ForEditorX(this HtmlHelper Html, FieldItem field, IEntity entity = null, Object htmlAttributes = null)
        {
            ...
            // 优先处理映射。因为映射可能是字符串
            {
                try
                {
                    var mhs = ForMap(Html, field, entity, htmlAttributes);
            ...
            {
                return Html.ForString(field.Name, (String)entity[field.Name], field.Length, htmlAttributes);
            }
            // 如果是实体树，并且当前是父级字段，则生产下拉
            if (entity is IEntityTree)
            {
                var mhs = ForTreeEditor(Html, field, entity as IEntityTree, htmlAttributes);
                if (mhs != null) return mhs;
            }
            ...
            return Html.ForEditorX(field.Name, entity[field.Name], field.Type, null, htmlAttributes);
        }
        ...
        private static MvcHtmlString ForMap(HtmlHelper Html, FieldItem field, IEntity entity, Object htmlAttributes = null)
        {
            var map = field.Map;
            ...
            if (map.Provider == null)
            {
                ...
                var mhs = Html.ForEditorX(field.Name, entity[field.Name], field.Type, null, htmlAttributes);
            ...
            return Html.ForDropDownListX(map.Name, map.Provider.GetDataSource(), entity[map.Name], null, false, htmlAttributes);
        }
        ...
        /// <param name="htmlAttributes"></param>
        /// <returns></returns>
        public static MvcHtmlString ForEditorX(this HtmlHelper Html, String name, IEntity entity = null, Object htmlAttributes = null)
        {
            if (entity == null) entity = Html.ViewData.Model as IEntity;
            ...
            return Html.ForEditorX(field, entity, htmlAttributes);
        }
        ...
        {
            if (value == null || Type.GetTypeCode(value.GetType()) != TypeCode.Object) return Html.ForEditorX(name, value);
            ...
            foreach (var pi in pis)
            {
                ...
                sb.AppendLine(Html.ForEditorX(pi.Name, value.GetValue(pi), pi.PropertyType).ToString());
        ...
        {
            var atts = htmlAttributes.ToAttrDictionary(); // HtmlHelper.AnonymousObjectToHtmlAttributes(htmlAttributes));
            TryAddAttribute(atts, "class", "form-control");
            ...
            else if (name.EqualIgnoreCase("Phone", "TelPhone", "OfficePhone", "HomePhone"))
            {
                ico = "<div class=\"input-group-prepend\"><span class=\"input-group-text\"><i class=\"la la-mobile\"></i></span></div>";
            ...
            {
                ico = "<div class=\"input-group-prepend\"><span class=\"input-group-text\"><i class=\"la la-envelope\"></i></span></div>";
                if (!atts.ContainsKey("type")) atts.Add("type", "email");
                txt = Html.TextBox(name, value, atts);
            }
            else if (name.EndsWithIgnoreCase("url"))
            {
                ico = "<div class=\"input-group-prepend\"><span class=\"input-group-text\"><i class=\"la la-home\"></i></span></div>";
                txt = Html.TextBox(name, value, atts);
            }
            else if (name.EndsWithIgnoreCase("tags"))
            {
                ico = "<div class=\"input-group-prepend\"><span class=\"input-group-text\"><i class=\"la la-tags\"></i></span></div>";
                txt = Html.TextBox(name, value, atts);
            }
            else if (name.EndsWithIgnoreCase("map", "LatLng"))
            {
                ico = "<div class=\"input-group-prepend\"><span class=\"input-group-text\"><i class=\"la la-map-marker\"></i></span></div>";
                txt = Html.TextBox(name, value, atts);
            }
        ...
        public static MvcHtmlString ForIntX(this HtmlHelper Html, String name, Int64 value, String format = null, Object htmlAttributes = null)
        {
            ...
            var atts = htmlAttributes.ToAttrDictionary();
            TryAddAttribute(atts, "class", "form-control");
            TryAddAttribute(atts, "role", "number");
        ...
        {
            var atts = htmlAttributes.ToAttrDictionary();
            TryAddAttribute(atts, "class", "form-control date form_datetime");
            ...
            // 首先输出图标
            var ico = Html.Raw("<div class=\"input-group-prepend\"><span class=\"input-group-text\"><i class=\"la la-calendar\"></i></span></div>");
            var txt = Html.TextBox(name, obj, format, atts);
            var icog = "<div class=\"input-group\">{0}</div>";

            return new MvcHtmlString(String.Format(icog, ico.ToString() + txt.ToString()));
        }
        ...
        public static MvcHtmlString ForDateTimeX<TModel, TProperty>(this HtmlHelper<TModel> Html, Expression<Func<TModel, TProperty>> expression, String format = null, Object htmlAttributes = null)
        {
            ...
            return Html.ForDateTimeX(meta.PropertyName, value, format, htmlAttributes);
        }
        ...
        {
            var atts = htmlAttributes.ToAttrDictionary();
            TryAddAttribute(atts, "class", "chkSwitch");
            // 因为得不到很好的样式支撑，暂时去掉CheckBox的Boostrap样式
            //if (!atts.ContainsKey("class")) atts.Add("class", "form-control");
            //TryAddAttribute(atts, "class", "<div><label  class=\"m-checkbox m-checkbox--success\"><input name=\"{0}\" value=\"{1}\" type=\"checkbox\"><span></span></label></div>");
        ...
        public static MvcHtmlString ForDescriptionX(this HtmlHelper Html, String name)
        {
            ...
            return Html.ForDescriptionX(field);
        }
        ...
        /// <returns></returns>
        public static MvcHtmlString ForEnumX(this HtmlHelper Html, String name, Object value, String label = null, Object htmlAttributes = null)
        {
            var atts = htmlAttributes.ToAttrDictionary();
            TryAddAttribute(atts, "class", "multiselect");
            ...
            var hmstr = Html.DropDownList(name, data, label, atts);
        ...
        /// <returns></returns>
        public static MvcHtmlString ForEnumX<T>(this HtmlHelper Html, String name, Boolean selectAll = false, Boolean autoPostback = false, Object htmlAttributes = null)
        {
            ...
            return Html.ForListBoxX(name, dic, values, autoPostback, htmlAttributes);
        }
        #endregion

        #region 下拉列表
        /// <summary>字典的下拉列表4</summary>
        /// <param name="Html"></param>
        /// <param name="name"></param>
        ...
        /// <param name="htmlAttributes"></param>
        /// <returns></returns>
        public static MvcHtmlString ForDropDownListX(this HtmlHelper Html, String name, IEnumerable items, Object selectedValue = null, String optionLabel = null, Boolean autoPostback = false, Object htmlAttributes = null)
        {
            ...
            if (autoPostback) TryAddAttribute(atts, "onchange", "$(this).parents('form').submit();");

            return Html.DropDownList(name, data, optionLabel, atts);
        }

        /// <summary>实体列表的下拉列表。单选，自动匹配当前模型的选中项3</summary>
        /// <param name="Html"></param>
        /// <param name="name"></param>
        ...
        /// <param name="autoPostback">自动回发</param>
        /// <returns></returns>
        public static MvcHtmlString ForDropDownListX(this HtmlHelper Html, String name, IList<IEntity> list, String optionLabel = null, Boolean autoPostback = false, Object htmlAttributes = null)
        {
            var entity = Html.ViewData.Model as IEntity;
        ...
        private static IDictionary<String, Object> ToAttrDictionary(this object htmlAttributes)
        {
            var atts = htmlAttributes == null
                ? new RouteValueDictionary()
                : htmlAttributes as IDictionary<String, Object>;
        ...
        private static void TryAddAttribute(IDictionary<String, Object> atts, String key, Object value)
        {
            if (atts == null) return;
            var att = atts.ContainsKey(key) ? atts[key] : "";
            att += (" " + value);
            atts[key] = att;
        }
        #endregion
