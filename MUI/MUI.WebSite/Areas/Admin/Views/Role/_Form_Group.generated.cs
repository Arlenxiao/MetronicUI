...
namespace ASP
{
    ...
    if (cls.IsNullOrEmpty()) { cls = "form-group col-12 col-sm-4 col-lg-4"; }

    string[] exes = { "扩展1", "扩展2", "扩展3", "扩展4", "扩展5", "扩展6" };
 ...
 if (item.Name == "Permission")
{
    if (!entity.IsNullKey)
    {
            ...
            #line 20 "..\..\Areas\Admin\Views\Role\_Form_Group.cshtml"
...
{
    if (!item.DisplayName.EqualIgnoreCase(exes))
    {
...
WriteLiteral(" class=\"form-group form-group-xs row\"");
...
WriteLiteral("            ");
            ...
            #line 28 "..\..\Areas\Admin\Views\Role\_Form_Group.cshtml"
...
WriteLiteral("\r\n        </div>\r\n");
            ...
            #line 30 "..\..\Areas\Admin\Views\Role\_Form_Group.cshtml"
    }
}
